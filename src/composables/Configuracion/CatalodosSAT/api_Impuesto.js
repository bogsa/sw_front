...
export default function use_Impuestos() {
    const url = useUrl();
    const auth = useAuth();
    const httpRSC = use_httpRSC();

    const apiData_Impuesto = ref([]);
    const statusCode_Impuesto = ref(null);
    const get_Impuesto = async () => {
        apiData_Impuesto.value = [];
        try {
            const configuracion = {
                method: 'GET',
                url: url.apisw + 'api/C_Impuesto/Listar',
                headers: {
            ...
            apiData_Impuesto.value = respuesta.data;
            statusCode_Impuesto.value = respuesta.status;
        } catch (error) {
            let res_error = null
    ...
    const post_Impuesto = async (data) => {
        try {
            const configuracion = {
                method: 'POST',
                url: url.apisw + 'api/C_Impuesto/Crear',
                headers: {
    ...
    const put_Impuesto = async (data) => {
        try {
            const configuracion = {
                method: 'PUT',
                url: url.apisw + 'api/C_Impuesto/Actualizar',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: 'Bearer ' + auth.token,
                },
