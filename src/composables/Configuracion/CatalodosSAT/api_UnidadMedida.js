...
export default function use_UnidadMedidas() {
    const url = useUrl();
    const auth = useAuth();
    const httpRSC = use_httpRSC();

    const apiData_UnidadMedida = ref([]);
    const statusCode_UnidadMedida = ref(null);
    const get_UnidadMedida = async () => {
        apiData_UnidadMedida.value = [];
        try {
            const configuracion = {
                method: 'GET',
                url: url.apisw + 'api/C_UnidadMedida/Listar',
                headers: {
            ...
            apiData_UnidadMedida.value = respuesta.data;
            statusCode_UnidadMedida.value = respuesta.status;
        } catch (error) {
            let res_error = null
    ...
    const post_UnidadMedida = async (data) => {
        try {
            const configuracion = {
                method: 'POST',
                url: url.apisw + 'api/C_UnidadMedida/Crear',
                headers: {
    ...
    const put_UnidadMedida = async (data) => {
        try {
            const configuracion = {
                method: 'PUT',
                url: url.apisw + 'api/C_UnidadMedida/Actualizar',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: 'Bearer ' + auth.token,
                },
    ...
    return {
        apiData_UnidadMedida,
        statusCode_UnidadMedida,
        get_UnidadMedida,
        post_UnidadMedida,
        put_UnidadMedida,
    }
